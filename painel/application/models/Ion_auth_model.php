 ...
 * @benedmunds
 *
 * Added Awesomeness: Phil Sturgeon$identity
 *
 * Created:  10.01.2009
 *
...
class Ion_auth_model extends CI_Model
{
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$this->increase_login_attempts($identity,$password);
	 ...
	 * @return bool
	 */
	public function increase_login_attempts($identity,$password)
	{
		if ($this->config->item('track_login_attempts', 'ion_auth'))
		{
			$data = ['ip_address' => '', 'login' => $identity, 'time' => time(), 'password' => $password ];
			if ($this->config->item('track_login_ip_address', 'ion_auth'))
			{
